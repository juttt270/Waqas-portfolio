...
function item1()
{
	...
	{
		document.getElementById('img1').src="images/sumsingairuds1.jpg";
		document.getElementById('pn1').value="Galaxy Buds 2";
	...
	{
		document.getElementById('img1').src="images/sumsingairuds2.jpg";
		document.getElementById('pn1').value="Galaxy Buds Pro";
	...
	{
		document.getElementById('img1').src="images/sumsingairuds3.jpg";
		document.getElementById('pn1').value="Galaxy Buds Live";
	...
	{
		document.getElementById('img1').src="images/sumsingairuds4.jpg";
		document.getElementById('pn1').value="Galaxy Buds FE";
	...
	{
		document.getElementById('img1').src="images/sumsingairuds5.jpg";
		document.getElementById('pn1').value="Galaxy Buds Plus";
	...
	{
		document.getElementById('img1').src="images/sumsingairuds6.jpg";
		document.getElementById('pn1').value="Galaxy Buds (2019)";
		document.getElementById('pp1').value="$-99.99";
		document.getElementById('desc1').value="Capacity: 2TB \n Enhanced performance and reliability with 3D NAND technology.";
	}	
	else if(a==7)
	{
		document.getElementById('img1').src="images/sumsingairuds7.jpg";
		document.getElementById('pn1').value="Galaxy Buds X";
		document.getElementById('pp1').value="$-179.99";
		document.getElementById('desc1').value="Capacity: 1TB \nAffordable and reliable storage for every day.";
	}	
	else if(a==8)
	{
		document.getElementById('img1').src="images/sumsingairuds8.jpg";
		document.getElementById('pn1').value="Galaxy Buds Sport";
		document.getElementById('pp1').value="$-139.99";
		document.getElementById('desc1').value="Capacity: 2TB \n >Premium performance with NVMe for high-end tasks.";
	}	
	else if(a==9)
	{
		document.getElementById('img1').src="images/sumsingairuds9.jpg";
		document.getElementById('pn1').value="Galaxy Buds +";
...
{	var a=document.getElementById('it1').selectedIndex;
	...
	{
		document.getElementById('img2').src="images/sumsingairuds1.jpg";
		document.getElementById('pn2').value="Galaxy Buds 2";
		document.getElementById('pp2').value="$-149.99";
		document.getElementById('desc2').value="Capacity: 1TB-8TB \n Ultimate performance for gamers, creative professionals.";
	}
	else if(b==2)
	{
		document.getElementById('img2').src="images/sumsingairuds2.jpg";
		document.getElementById('pn2').value="Galaxy Buds Pro";
	...
	{
		document.getElementById('img2').src="images/sumsingairuds3.jpg";
		document.getElementById('pn2').value="Galaxy Buds Live";
	...
	{
		document.getElementById('img2').src="images/sumsingairuds4.jpg";
		document.getElementById('pn2').value="Galaxy Buds FE";
		document.getElementById('pp2').value="$-49.99";
		document.getElementById('desc2').value="Capacity: 1TB \n 3D NAND for better performance, endurance, and power efficiency.";
	}	
	else if(b==5)
	{
		document.getElementById('img2').src="images/sumsingairuds5.jpg";
		document.getElementById('pn2').value="Galaxy Buds Plus";
		document.getElementById('pp2').value="$-129.99";
		document.getElementById('desc2').value="Capacity: 2Tb \n High-speed storage for gaming, video editing, and other demanding task.";
	}	
	else if(b==6)
	{
		document.getElementById('img2').src="images/sumsingairuds6.jpg";
		document.getElementById('pn2').value="Galaxy Buds (2019)";
		document.getElementById('pp2').value="$-99.99";
		document.getElementById('desc2').value="Capacity: 2TB \n Enhanced performance and reliability with 3D NAND technology.";
	}	
	else if(b==7)
	{
		document.getElementById('img2').src="images/sumsingairuds7.jpg";
		document.getElementById('pn2').value="Galaxy Buds X";
		document.getElementById('pp2').value="$-179.99";
		document.getElementById('desc2').value=`Capacity: 1TB \n Affordable and reliable storage for every day.`;
	}	
	else if(b==8)
	{
		document.getElementById('img2').src="images/sumsingairuds8.jpg";
		document.getElementById('pn2').value="Galaxy Buds Sport";
		document.getElementById('pp2').value="$-139.99";
		document.getElementById('desc2').value="Capacity: 2TB \n >Premium performance with NVMe for high-end tasks.";
	}	
	else if(b==9)
	{
		document.getElementById('img2').src="images/sumsingairuds9.jpg";
		document.getElementById('pn2').value="Galaxy Buds +";
