...
function item1() {
	...
	if (a == b) {
		...
		document.getElementById('img1').src = "images/card1.png";
		document.getElementById('pn1').value = "EVO Plus microSD Card";
		document.getElementById('pp1').value = "$-114.99";
		document.getElementById('desc1').value = "Capacity: 1TB-8TB \n Ultimate performance for gamers, creative professionals.";
	}
	else if (a == 2) {
		document.getElementById('img1').src = "images/card1.png";
		document.getElementById('pn1').value = "Samsung PRO Plus microSD Card";
		document.getElementById('pp1').value = "$-63.99";
		document.getElementById('desc1').value = "Capacity: 1Tb-8TB \n Reliable performance for everyday computing tasks with 3D NAND.";
	}

	else if (a == 3) {
		document.getElementById('img1').src = "images/card3.png";
		document.getElementById('pn1').value = "PRO Endrurance microSD card 256GB";
		...
		document.getElementById('img1').src = "images/card4.png";
		document.getElementById('pn1').value = "Pro Plus microSD Card (2021)";
		...
		document.getElementById('img1').src = "images/card5.png";
		document.getElementById('pn1').value = "Evo Plus microSD Card (2021)";
		...
		document.getElementById('img1').src = "images/card6.png";
		document.getElementById('pn1').value = "Evo Plus microSD card (2020) 512GB";
		document.getElementById('pp1').value = "$-99.99";
		document.getElementById('desc1').value = "Capacity: 2TB \n Enhanced performance and reliability with 3D NAND technology.";
	}
	else if (a == 7) {
		document.getElementById('img1').src = "images/card7.png";
		document.getElementById('pn1').value = "PRO Endurance microSD Card 128GB";
...
function item2() {
	...
	if (a == b) {
		...
		document.getElementById('img2').src = "images/card1.png";
		document.getElementById('pn2').value = "EVO Plus microSD Card";
		document.getElementById('pp2').value = "$-114.99";
		document.getElementById('desc2').value = "Capacity: 1TB-8TB \n Ultimate performance for gamers, creative professionals.";
	}
	else if (b == 2) {
		document.getElementById('img2').src = "images/card2.png";
		document.getElementById('pn2').value = "Samsung PRO Plus microSD Card";
		document.getElementById('pp2').value = "$-63.99";
		document.getElementById('desc2').value = "Capacity: 1Tb-8TB \n Reliable performance for everyday computing tasks with 3D NAND.";
	}

	else if (b == 3) {
		document.getElementById('img2').src = "images/card3.png";
		document.getElementById('pn2').value = "PRO Endrurance microSD card 256GB";
		document.getElementById('pp2').value = "$-44.99";
		document.getElementById('desc2').value = "Capacity: 240GB \n Affordable SSD with great speed for everyday computing.";
	}

	else if (b == 4) {
		document.getElementById('img2').src = "images/card4.png";
		document.getElementById('pn2').value = "Pro Plus microSD Card (2021)";
		document.getElementById('pp2').value = "$-49.99";
		document.getElementById('desc2').value = "Capacity: 1TB \n 3D NAND for better performance, endurance, and power efficiency.";
	}
	else if (b == 5) {
		document.getElementById('img2').src = "images/card5.png";
		document.getElementById('pn2').value = "Evo Plus microSD Card (2021)";
		document.getElementById('pp2').value = "$-84.99";
		document.getElementById('desc2').value = "Capacity: 2Tb \n High-speed storage for gaming, video editing, and other demanding task.";
	}
	else if (b == 6) {
		document.getElementById('img2').src = "images/card6.png";
		document.getElementById('pn2').value = "Evo Plus microSD card (2020) 512GB";
		document.getElementById('pp2').value = "$-99.99";
		document.getElementById('desc2').value = "Capacity: 2TB \n Enhanced performance and reliability with 3D NAND technology.";
	}
	else if (b == 7) {
		document.getElementById('img2').src = "images/card7.png";
		document.getElementById('pn2').value = "PRO Endurance microSD Card 128GB";
