...
function item1()
{
	...
	else if(a==1)
	{
		...
		document.getElementById('pn1').value="WD_BLACK SN850X NVMe™ SSD - 1TB, Without Heatsink";
	...
	else if(a==2)
	{
		...
		document.getElementById('pn1').value="WD_BLACK SN850P NVMe™ SSD for PS5® consoles - 1 TB";
	...
	else if(a==3)
	{
		...
		document.getElementById('pn1').value="WD Blue SN5000 NVMe™ SSD - 500 GB";
	...
	else if(a==4)
	{
		...
		document.getElementById('pn1').value="SanDisk Extreme M.2 NVMe PCIe Gen 4.0 Internal SSD - 500 GB";
